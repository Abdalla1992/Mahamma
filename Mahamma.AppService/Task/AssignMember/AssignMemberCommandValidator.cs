...
namespace Mahamma.AppService.Task.AssignMember
{
    public class AssignMemberCommandValidator : AbstractValidator<AssignMemberCommand>
    {
        ...
        public AssignMemberCommandValidator(ITaskRepository taskRepository, Microsoft.AspNetCore.Http.IHttpContextAccessor httpContext, IMessageResourceReader messageResourceReader)
        {
