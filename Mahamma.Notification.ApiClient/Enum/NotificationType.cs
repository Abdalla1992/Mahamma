...
namespace Mahamma.Notification.ApiClient.Enum
{
    public class NotificationType : Enumeration
    {
        ...
        #region Methods
        public static IEnumerable<NotificationType> List() => new[] { AddProject, ArchiveProject, AssignMemberToProject, DeleteProject, UpdateProject, AddComment,
        AddTask,ArchiveTask,AssignMemberToTask,DeleteTask,LikeComment,SubmitTask,UpdateTask,AssignMemberToWorkspace,AddWorkspace,UpdateWorkspace,AddSubTask, AcceptedTask, RejectTask, MentionComment,
        MeetingAdded, MeetingUpdated, MeetingCanceled, UpdateSubTask, DeleteSubTask, TaskIsInProgress, SubTaskIsInProgress, MinuteOfMeetingAdded};
