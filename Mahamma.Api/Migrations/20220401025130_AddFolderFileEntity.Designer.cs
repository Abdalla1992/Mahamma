...
namespace Mahamma.Api.Migrations
{
    ...
    [Migration("20220401025130_AddFolderFileEntity")]
    partial class AddFolderFileEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mahamma.Domain.Folder.Entity.Folder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Mahamma.Domain.Folder.Entity.FolderFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Mahamma.Domain.Folder.Entity.FolderFile", b =>
                {
                    b.HasOne("Mahamma.Domain.Folder.Entity.Folder", null)
                        .WithMany("folderFiles")
                        .HasForeignKey("FolderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Mahamma.Domain.ProjectAttachment.Entity.ProjectAttachment", null)
                        .WithMany("folderFiles")
