...
namespace Mahamma.Api.Infrastructure.AutofacHandler
{
    public class ApplicationModule : Autofac.Module
    {
        ...
        {
            System.Type[] repositories = System.Reflection.Assembly.Load(typeof(Mahamma.Infrastructure.Repositories.WorkspaceRepository).Assembly.GetName()).GetTypes().ToArray();
            System.Type[] iRepositories = System.Reflection.Assembly.Load(typeof(Domain.Workspace.Repository.IWorkspaceRepository).Assembly.GetName()).GetTypes().Where(r => r.IsInterface).ToArray();
