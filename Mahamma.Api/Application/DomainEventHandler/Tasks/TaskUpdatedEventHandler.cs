...
namespace Mahamma.Api.Application.DomainEventHandler.Tasks
{
    public class TaskUpdatedEventHandler : INotificationHandler<TaskUpdatedEvent>
    {
        ...
        public TaskUpdatedEventHandler(IMediator mediator, INotificationResourceReader notificationResourceReader, INotificationService notificationService)
        {
            _mediator = mediator;
        ...
        public async Task Handle(TaskUpdatedEvent request, CancellationToken cancellationToken)
        {
        ...
        {
            NotificationType notificationType = !isSubTask ? NotificationType.UpdateTask : NotificationType.UpdateSubTask;
